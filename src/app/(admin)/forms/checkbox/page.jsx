...
const InlineCheckbox = () => {
  return (
    <ComponentContainerCard id="inline-checkbox" title="Inline Checkbox">
...
const DisabledCheckbox = () => {
  return (
    <ComponentContainerCard id="disabled-checkbox" title="Disabled Checkbox">
...
const ColorsCheckbox = () => {
  return (
    <ComponentContainerCard id="colors-checkbox" title="Colors Checkbox">
      <div className="mt-2">
...
const InlineRadio = () => {
  return (
    <ComponentContainerCard id="inline-radio" title="Inline Radio">
...
const DisabledRadio = () => {
  return (
    <ComponentContainerCard id="disabled-radio" title="Disabled Radio">
...
const ColorsRadio = () => {
  return (
    <ComponentContainerCard id="colors-radio" title="Colors Radio">
      {colorVariants.slice(0, 7).map((color, idx) => (
